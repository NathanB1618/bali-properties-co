...
const Index = () => {
  ...
  return (
    <>
      ...
      {/* Stats Section */}
      <section className="bg-bali-sand py-12">
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="animated-element">
              <PropertyCard 
                image="https://images.unsplash.com/photo-1582650625119-3a31a7d8b891?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80"
            ...
            <div className="animated-element">
              <PropertyCard 
                ...
                title="Luxury Pool Villa in Canggu"
                price="$495,000 USD"
            ...
            <div className="animated-element">
              <PropertyCard 
                ...
                title="Beachfront Villa in Uluwatu"
                price="$650,000 USD"
