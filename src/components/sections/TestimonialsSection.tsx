        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="animated-element">
            <TestimonialCard 
              ...
              quote="Investing in our Seminyak villa was the best decision we've made. It pays for itself with rental income and gives us an amazing place to holiday. The whole process was seamless."
              rating={5}
