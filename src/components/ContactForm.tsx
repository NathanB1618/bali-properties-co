...
const ContactForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-rich-blue rounded-xl shadow-lg p-6 md:p-8 text-white guide-highlight">
      ...
      <div className="space-y-4">
        ...
        <Button 
          type="submit" 
          className="w-full bg-[#0d9488] hover:bg-teal-700 text-white font-medium text-lg py-4 h-14 rounded-lg transition-colors"
        >
